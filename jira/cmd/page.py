...
def get(page_title: str = typer.Argument(help="The page title"),
...
def create(page_title: str = typer.Argument(help="The page title"),
        space_key: str = typer.Argument(help="The space key"),
...
def update(page_title: str = typer.Argument(help="The page title"),
        space_key: str = typer.Argument(help="The space key"),
        page_file: str = typer.Argument(help="The page file")
    ):
    with open(page_file,'r') as page_raw:
...
def move(page_title: str = typer.Argument(help="The page title"),
        space_key: str = typer.Argument(help="The space key"),
        parent_id: str = typer.Argument(help="The parent page id")
    ):
